...
PM_START_TEXT = """ 
*𝖧𝖤𝖸* {} , 🥀
*๏ 𝖨'𝖬 {} 𝖨'𝖬 𝖧𝖾𝗋𝖾 𝗍𝗈 𝗁𝖾𝗅𝗉 𝗒𝗈𝗎 𝗆𝖺𝗇𝖺𝗀𝖾 𝗒𝗈𝗎𝗋 𝗀𝗋𝗈𝗎𝗉𝗌!
𝗛𝗮𝘁𝘀𝘂𝗻𝗲 𝗠𝗶𝗸𝘂 𝗂𝗌 𝖺 𝗏𝗂𝗋𝗍𝗎𝖺𝗅 𝗉𝗈𝗉 𝗌𝗍𝖺𝗋. She can easily manage your groups and even play songs.*
➻ *𝖢𝗅𝗂𝖼𝗄 𝗈𝗇 𝗍𝗁𝖾 𝖻𝗎𝗍𝗍𝗈𝗇 𝖻𝖾𝗅𝗈𝗐 𝗍𝗈 𝗀𝖾𝗍 𝖽𝖾𝗌𝖼𝗋𝗂𝗉𝗍𝗂𝗈𝗇 𝖺𝖻𝗈𝗎𝗍 𝗌𝗉𝖾𝖼𝗂𝖿𝗂𝖼 𝖼𝗈𝗆𝗆𝖺𝗇𝖽.*
─────────────────
   *➻ ᴜsᴇʀs »* {}
   *➻ ᴄʜᴀᴛs »* {}
─────────────────
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=" ʙᴀᴄᴋ ", callback_data="Music_"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", url="https://t.me/THEDARKOUTLAWS")
                    ]
                ]
            ),
        )
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        ...
        send_help(
            ...
            text,
            InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="◁", callback_data="help_back"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", url="https://t.me/THEDARKOUTLAWS")]]
            ),
        )
